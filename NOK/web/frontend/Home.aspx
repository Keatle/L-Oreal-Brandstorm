<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Home.aspx.cs" Inherits="AdonisMen.Home" %>
                        ...
                        <div class="owl-men-item owl-carousel">
                            <div class="item">
                                <div class="thumb">
                                    <div class="hover-content">
                                        <ul>
                                            <li><a href="Cart.aspx"><i class="fa fa-eye"></i></a></li>
                                            <li><a href="Cart.aspx"><i class="fa fa-star"></i></a></li>
                                            <li><a href="Cart.aspx"><i class="fa fa-shopping-cart"></i></a>
                                            </li>
                                        </ul>
                                    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    <div class="left-content">
                        ...
                        <p>
                            If this template is beneficial for your website or business, please kindly <a rel="nofollow"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <ul>
                                ...
                                <li>Social Media:<br>
                                    <span><a href="#">Facebook</a>, <a href="#">Instagram</a>, <a
